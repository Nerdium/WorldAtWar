...
public class ChunkGroup {
	private Map<ChunkPosition, AdjacentChunk> chunkGroupMap = new HashMap<>();
    ...
    public List<Point> traceShapePerimeter() {
        ChunkEdge startEdge = null;
        int nTotalEdgeCount = 0;

        Map<Point, List<ChunkEdge>> pointSearchMap = new HashMap<>();
        ...
        if (!pointSearchMap.isEmpty()) {
            ...
            do {
                ...
                if (curEdge != null) {
                	...
                	//WorldAtWar.logger.warning("Unable to successfully trace claim chunk perimeter. This claim will not be visible on dynmap.");
                    bTraceError = true;
                    break;
                }
                ...
                if (nLoopLimit <= 0) {
                    //WorldAtWar.logger.warning("Unable to find starting point in claim trace. This claim will not be visible on dynmap.");
                    bTraceError = true;
                    break;
                }
